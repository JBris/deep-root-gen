...
PAGE_ID = "sensitivity-analysis-root-system-page"
...
def run_root_model(
    ...
    flow_data = run_deployment(
        "sensitivity_analysis/run_sensitivity_analysis_flow",
...
register_page(
    __name__, name="Sensitivity Analysis", top_nav=True, path="/sensitivity-analysis"
)
